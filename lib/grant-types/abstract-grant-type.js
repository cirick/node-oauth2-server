...
AbstractGrantType.prototype.generateAccessToken = function(client, user, scope) {
  if (this.model.generateAccessToken) {
    return promisify(this.model.generateAccessToken.bind(this.model), 3)(client, user, scope)
...
AbstractGrantType.prototype.generateRefreshToken = function(client, user, scope) {
  if (this.model.generateRefreshToken) {
    return promisify(this.model.generateRefreshToken.bind(this.model), 3)(client, user, scope)
...
AbstractGrantType.prototype.validateScope = function(user, client, scope) {
  if (this.model.validateScope) {
    return promisify(this.model.validateScope.bind(this.model), 3)(user, client, scope)
      .then(function (scope) {
        if (!scope) {
