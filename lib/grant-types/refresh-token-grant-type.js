...
RefreshTokenGrantType.prototype.getRefreshToken = function(request, client) {
  ...
  return promisify(this.model.getRefreshToken.bind(this.model), 1)(request.body.refresh_token)
    .then(function(token) {
      if (!token) {
...
RefreshTokenGrantType.prototype.revokeToken = function(token) {
  ...
  return promisify(this.model.revokeToken.bind(this.model), 1)(token)
...
RefreshTokenGrantType.prototype.saveToken = function(user, client, scope) {
  ...
  return Promise.all(fns)
    ...
    .then(function(token) {
      return Promise.try(promisify(this.model.saveToken.bind(this.model), 3), [token, client, user])
